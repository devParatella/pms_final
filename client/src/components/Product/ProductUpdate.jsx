    ...
    const fetchProduct = async () => {
      try {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Erro',
          text: 'Erro ao carregar a acomodação',
        });
      }
    };
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (parseFloat(product.hourlyRate) <= 0) {
      Swal.fire({
        icon: 'warning',
        title: 'Atenção!',
        text: 'Digite um número maior que zero para o valor por diária.',
      });
      return;
    }
    ...
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Erro',
        text: 'Erro ao atualizar a acomodação',
      });
    }
  };
      ...
      <main id="main" className="main">
        ...
        <div className="update-form-container">
          <form onSubmit={handleFormSubmit} className="update-form-grid">
            ...
            <button className="update-form-button" type="submit">Atualizar Acomodação</button>
