...
const ProductList = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        Swal.fire({
          icon: 'error',
          title: 'Erro!',
          text: 'Erro ao buscar acomodações'
        });
      }
    };
  ...
  const handleDelete = async (productID) => {
    const isConfirmed = await Swal.fire({
      ...
      text: 'Você realmente deseja deletar esta acomodação?',
      icon: 'warning',
    ...
    try {
      ...
      Swal.fire({
        icon: 'success',
        title: 'Sucesso!',
        text: 'Acomodação deletada com sucesso!'
      });
    } catch (error) {
      Swal.fire({
        icon: 'warning',
        title: 'Atenção!',
        text: 'Não é possível deletar a acomodação pois ela está conectada a uma reserva ativa.'
      });
    }
  };
  ...
  const handleInfos = (product) => {
    Swal.fire({
      ...
      text: product.description || "Essa acomodação não possui descrição",
      icon: 'info',
          ...
          <table className='product-table-content'>
            <thead>
              <tr>
                ...
                <th className="col-rate">Valor por Diária</th>
