    ...
    var docDefinition = {
      content: [
        ...
        { text: '\n' },
        {
          table: {
            headerRows: 1,
            widths: [20, 125, 125, 50, 50, 50, 110],
            body: [
              ...
              ...reservations.map(reservations => ([
                ...
                { text: formatDate(reservations.checkin), style: 'item' },
                { text: formatDate(reservations.checkout), style: 'item' },
              ...
              [{ text: `Total: ${reservations.length}`, colSpan: 7, style: 'total' },
              {}]
            ]
          },
          style: 'tableExample'
